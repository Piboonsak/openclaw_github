...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.loopDetection.rapidSuccessionThreshold": "Tool-loop Rapid-Succession Storm Threshold",
  ...
  "tools.loopDetection.detectors.rapidSuccession": "Tool-loop Rapid-Succession Storm Detection",
